...
public abstract class AbstractProcessingData implements ProcessingData,ApplicationContextAware, InitializingBean {
    ...
    protected ITbDbPurchaserService purchaserService;
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        this.elasticsearchTemplate = applicationContext.getBean(ElasticsearchTemplate.class);
    }
